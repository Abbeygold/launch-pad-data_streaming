        ...
        "results": [
            {
                ...
                "webTitle": "Who said what: using machine learning to correctly ...",
...
def test_fetch_articles_success(mock_get):
    ...
    assert (
        articles[0]["webTitle"] == MOCK_RESPONSE["response"]["results"][0]["webTitle"]
    )
...
def test_fetch_articles_with_content_preview(mock_fetch_article_details, mock_get):
    ...
    dummy_article_content = "This is a dummy content"
